...
} from "./plasmic/copy_of_teste_plasmic_sync/PlasmicCombobox";
...
function Combobox_(props: ComboboxProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicCombobox root={{ ref }} {...props} />;
}

const Combobox = React.forwardRef(Combobox_);
